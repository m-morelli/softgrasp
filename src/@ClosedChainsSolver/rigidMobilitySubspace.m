%ClosedChainsSolver.RIGIDMOBILITYSUBSPACE. Compute the Mobility Subspaces for Rigid Closed-Chain Mechanisms
...
%       - Using the subspaceDecomp method
...
function [gOutRM] = rigidMobilitySubspace(varargin)

    [gOutRM] = subspaceDecomp(varargin{:}, @llc_hmob);