%ClosedChainsSolver.RIGIDMANIPULABILITYSUBSPACE. Compute the Manipolability Subspaces for Rigid Closed-Chain Mechanisms
...
function [gOutRM] = rigidManipulabilitySubspace(varargin)

    [gOutRM] = subspaceDecomp(varargin{:}, @llc_hmanip);