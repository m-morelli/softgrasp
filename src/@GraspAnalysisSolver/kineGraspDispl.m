% GraspAnalysisSolver.KINEGRASPDISPL. Compute Solutions Involving Object Displacements, but
% No Contact Force Variation
...
function StructOut = kineGraspDispl( grsp_poe )
