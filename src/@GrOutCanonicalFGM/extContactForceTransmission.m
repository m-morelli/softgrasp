% GrOutCanonicalFGM.EXTCONTACTFORCETRANSMISSION. Compute the Contact Force Transmission Caused by an External Wrench
...
function [mWf] = extContactForceTransmission(goobj)
    ...
    mWf = -goobj.cFGMstruct.FGM( goobj.f_block_idx, goobj.d_we_idx );
end