% GrOutCanonicalFGM.CONTROLLABLEINTERNALOBJDISPL. Compute the Controllable Internal Object Displacements
...
function [Ru] = controllableInternalObjDispl(goobj)
    ...
    Ru = goobj.cFGMstruct.FGM( goobj.u_block_idx, goobj.d_last_idx );
end